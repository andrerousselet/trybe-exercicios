...
const filterFunc = (pokemon) => pokemon.name === 'Pikachu';
const callbackFunc = (error, message) => (error) ? console.log(error) : console.log(message);

getPokemonDetails(filterFunc, callbackFunc);
