...
// Resposta: A, B e C, pois são funções síncronas, ou seja, ocorrem na ordem em que são chamadas.
...
// Resposta: A, C e B, pois setTimout as torna funções assíncronas, e C tem como parâmetro 2 seg, enquanto B tem 3 seg...
